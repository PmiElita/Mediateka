					...
					<c:forEach items="${requestedEvents}" var="current">
						<li id="eventNo${current.id}">
							...
							<div class="collapsible-body">
								...
								<p>
									<fmt:message bundle='${msg}' key='from' />: ${current.dateFrom}"
								</p>

								<p>
										<fmt:message bundle='${msg}' key='till' />: ${current.dateTill}"
								</p>

								<p>
									<fmt:message bundle='${msg}' key='type' />: <fmt:message bundle='${msg}' key='${current.type}' />
								</p>
