...
<body>
		...
		<div class="parallax-container my-parallax">
			...
			<div class="container white">
				<div class="section white center">
					...
					<h3>
						<fmt:message bundle="${msg }" key="change_user_info_form_title" />
					</h3>
					<div id="user_modification_form">

						<form id="userChangingForm" onsubmit="return updateUser();">
							...
							<div class="row">
								...
								<div class="input-field col s3" style="margin-top: 0em">
									...
									<input id="change_user_form_eduInstitution" name="institution"
										type="text" value="<c:out value="${user.eduInstitution }" />"
							...
							<div class="row">
								...
								<div class="input-field col s3">
									...
									<input id="change_user_form_oldEmail"
										value="<c:out value="${user.email }" />" hidden=""> <input
										id="change_user_form_email" name="email" type="text"
	...
	<script type="text/javascript">
		function updateUser() {
			...
			Materialize.toast("updating user", 4000);
			userChangingForm = document.getElementById("userChangingForm");
			$("userChangingForm").validate()
			console.log($("userChangingForm"));
			console.log(document.getElementById("userChangingForm"));
