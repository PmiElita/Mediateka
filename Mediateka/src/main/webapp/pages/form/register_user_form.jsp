							...
							<div class="col s12">
								<div class="row">
									...
									<div class="input-field col s3">
										...
										<input id="firstName" name="firstName" type="text"
											class="validate" pattern="${consts.getOnlyChars() }" required="required">
									</div>
									<div class="input-field col s3">
										<p>
								...
								<div class="row">
									...
									<div class="input-field col s3">
										...
										<select id="profession" name="profession"
											class="browser-default" style="margin-top: 0.75em" required="required">
									...
									<div class="input-field col s3" style="margin-top: 0em">
										...
										<input id="eduInstitution" name="institution" type="text"
											class="validate" style="margin-top: 0.75em" pattern="${consts.getAnyCharacters() }" required="required">
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="input-field col s3">
										...
										<input id="email" name="email" type="text" class="validate" pattern="${consts.getEmail() }" required="required"
										onchange="
											$.ajax(
												{
													url:'checkemail', 
									...
									<div class="input-field col s3">
										...
										<input id="adress" name="address" type="text" class="validate" pattern="${consts.getAnyCharacters() }" required="required">
									</div>
									<div class="input-field col s3">
										<p>
											<fmt:message bundle="${msg}" key="registration.phone" />
										</p>
										<input id="phone" name="phone" type="text" class="validate" pattern="${consts.getPhoneNumber() }" required="required">
									</div>
