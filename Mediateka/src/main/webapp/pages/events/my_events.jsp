...
<div class="parallax-container my-parallax">
			...
			<div class="row" style="margin-top: -1em">
				<div class="col s12">
					<ul class="tabs">
						<li class="tab col s2" style="margin-left: 5em;"><a href="#my_active_events">Active</a></li>
						<li class="tab col s2" style="margin-left: -5em"><a href="#my_blocked_events">Blocked</a></li>
					</ul>
				</div>
				</div>
		...
		<div class="row my-picture-row">
			<div class="col s8 offset-s2">
				<div class="waves-effect waves-block waves-light my-picture-wrap">
					<a href="events?eventId=${item.id}">
						<div align="center">
							<h3 class="image-cover-t"><c:out value="${item.name}"/>
							</h3><img class="my-picture-club" src="${myActiveEventsAvas[status.index]}" align="middle">
						</div>
					</a>
				</div>
			</div>
			...
			<div class="col s8 offset-s2">
				<div class="waves-effect waves-block waves-light my-picture-wrap">
					<a href="event?eventId=${item.id}">
						<div align="center">
							<h3 class="image-cover-t"><c:out value="${item.name}"/>
							</h3><img class="my-picture-club" src="${myBlockedEventsAvas[status.index]}" align="middle">
						</div>
					</a>
				</div>
			</div>
