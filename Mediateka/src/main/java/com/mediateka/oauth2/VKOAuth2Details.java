...
public class VKOAuth2Details {
    public static final String clientId="4975517";//!!!!!!!
    public static final String clientSecret="VvVrSgPwMF1BpI9y4Npt";//!!!!
    ...
    public static final String redirectUri="http://localhost:8080/Mediateka/vkLoginCode";//!!!
