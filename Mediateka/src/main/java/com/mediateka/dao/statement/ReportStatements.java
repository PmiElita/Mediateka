...
public class ReportStatements {
	public static final String INSERT_REPORT = "INSERT INTO report "
			+ "(email, text, name, date, state, response, admin_id) "
			+ " VALUES (?,?,?,?,?, ?, ?) ";
	public static final String[] INSERT_REPORT_ORDER = { "email", "text",
			"name", "date", "state", "response", "admin_id" };

	public static final String UPDATE_REPORT = "UPDATE report SET email=?, text=?, name=?, date=?, state=?, response=?, admin_id=? "
			+ " WHERE id = ?";
	public static final String[] UPDATE_REPORT_ORDER = { "email",
			"text", "name", "date", "state", "response", "admin_id", "id" };
