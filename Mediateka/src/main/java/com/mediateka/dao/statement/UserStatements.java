...
public class UserStatements {
	public static final String INSERT_USER = "INSERT INTO user "
			...
			+ " phone, adress, join_date, email, password, role, state, is_form_active)"
			+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ";
	public static final String[] INSERT_USER_ORDER = { "form_id", "first_name",
			...
			"join_date", "email", "password", "role", "state" , "is_form_active" };
